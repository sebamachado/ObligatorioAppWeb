<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListIterminals.aspx.cs" Inherits="ListIterminals" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Listar Terminales Internacionales </title>
    ...
    <form id="form1" runat="server">
        <div class="page-content">
            ...
            <div class="grid-container">
                <asp:GridView ID="gvListIterminals" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None">
