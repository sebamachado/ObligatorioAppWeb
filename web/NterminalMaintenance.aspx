<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NterminalMaintenance.aspx.cs" Inherits="NterminalMaintenance" %>
...
<body>
    <form id="form1" runat="server">
        <div class="page-content">
            ...
            <div class="header">
                Mantenimiento de Terminales Nacionales
            </div>
<table class="table-container">
    ...
    <tr>
        ...
        <td class="input-cell" colspan="2">
            <asp:RadioButtonList ID="rbl_taxiService" runat="server" RepeatDirection="Horizontal">
